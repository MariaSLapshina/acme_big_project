...
const [ccny,fullstack] = await Promise.all(schools.map(school => School.create(school)))
await Promise.all(students.map(student => Student.create({...student,schoolId: ccny.id})))
